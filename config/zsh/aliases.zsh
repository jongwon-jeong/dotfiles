...
alias vda='cd ~/proj/personal/dotfiles/ && vimdiff ~/.dotfiles/config/zsh/aliases.zsh config/zsh/aliases.zsh'
alias dl='mkdir ~/Downloads && cd ~/Downloads'
alias dc='mkdir ~/Documents && cd ~/Documents'
alias p='mkdir ~/proj && cd ~/proj'
